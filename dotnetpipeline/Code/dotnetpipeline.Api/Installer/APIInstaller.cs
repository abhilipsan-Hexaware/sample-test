...
using ElmahCore.Mvc;
using ElmahCore;
using dotnetpipeline.Api.Filters;
using dotnetpipeline.BusinessServices.Installer;

namespace dotnetpipeline.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetpipeline API", Version = version + "-" + branch});
            });
