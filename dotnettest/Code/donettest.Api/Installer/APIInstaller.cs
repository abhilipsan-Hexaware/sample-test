...
using ElmahCore.Mvc;
using ElmahCore;
using donettest.Api.Filters;
using donettest.BusinessServices.Installer;

namespace donettest.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "donettest API", Version = version + "-" + branch});
            });
