...
using ElmahCore.Mvc;
using ElmahCore;
using IDPService.Api.Filters;
using IDPService.Business.Installer;

namespace IDPService.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "IDPService API", Version = version + "-" + branch});
            });
